...
namespace Daedalus
{
	...
	public:
		...
		SpotLightSource(glm::vec3 light_pos, glm::vec3 ambient_color, glm::vec3 diffuse_color, glm::vec3 specular_color, float light_power, float max_distance, glm::vec3 direction, float theta_angle, float outer_cutoff);
